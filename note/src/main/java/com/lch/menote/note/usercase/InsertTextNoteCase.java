...
public class InsertTextNoteCase implements Runnable {
    private final int position;
    private NoteElementController controller;
    private WeakReference<ControllerCallback<Void>> ref;

    public InsertTextNoteCase(ControllerCallback<Void> cb,int position) {
    ...
    @Override
    public void run() {
        final ResponseValue<Void> res = controller.insertText(position);
