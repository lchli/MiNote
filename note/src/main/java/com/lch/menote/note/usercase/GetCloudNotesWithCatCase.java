...
public class GetCloudNotesWithCatCase implements Runnable {
    ...
    public GetCloudNotesWithCatCase(@NonNull ControllerCallback<List<Object>> cb, String tag, String title, boolean sortTimeAsc, String useId, Context context) {
    ...
    @Override
    public void run() {
        final ResponseValue<List<Object>> res = noteController.getCloudNotesWithCat(tag, title, sortTimeAsc, useId);
