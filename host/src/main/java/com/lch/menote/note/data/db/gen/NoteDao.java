...
public class NoteDao extends AbstractDao<Note, String> {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"NOTE\" (" + //
                ...
                "\"LAST_MODIFY_TIME\" INTEGER NOT NULL ," + // 2: lastModifyTime
                "\"TITLE\" TEXT," + // 3: title
                "\"TYPE\" TEXT," + // 4: type
    ...
    protected final void bindValues(DatabaseStatement stmt, Note entity) {
        ...
        stmt.bindLong(3, entity.getLastModifyTime());
    ...
    public Note readEntity(Cursor cursor, int offset) {
        Note entity = new Note( //
            ...
            cursor.getLong(offset + 2), // lastModifyTime
    ...
    public void readEntity(Cursor cursor, Note entity, int offset) {
        ...
        entity.setLastModifyTime(cursor.getLong(offset + 2));
