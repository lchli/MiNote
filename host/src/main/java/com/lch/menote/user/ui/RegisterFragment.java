...
public class RegisterFragment extends BaseFragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        userPrensenter = new UserPrensenter(DI.provideRegisterUseCase(),DI.provideLoginUseCase(),DI.provideUpdateUseCase(),DI.provideUploadFileUseCase());
